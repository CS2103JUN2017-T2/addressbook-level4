...
public class ArgumentTokenizer {
     ...
     * their respective argument values. Only the given prefixes will be recognized in the arguments string.
     *
    ...
    public static ArgumentMultimap tokenize(String argsString, Prefix... prefixes) {
        List<PrefixPosition> positions = findAllPrefixPositions(" " + argsString.trim() + " ", prefixes);
        return extractArguments(" " + argsString.trim() + " ", positions);
    }
    ...
    /**
     * Extracts prefixes and their argument values, and returns an {@code ArgumentMultimap} object that maps
     * the
