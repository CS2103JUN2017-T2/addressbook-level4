...
public class UniqueEntryList implements Iterable<Entry> {
     ...
     */
    public void add(ReadOnlyEntry toAdd) throws DuplicatePersonException {
     ...
     */
    public void updatePerson(ReadOnlyEntry target, ReadOnlyEntry editedPerson)
        ...
        Entry personToUpdate = internalList.get(index);
     ...
     */
    public boolean remove(ReadOnlyEntry toRemove) throws PersonNotFoundException {
    ...
    public void setPersons(List<? extends ReadOnlyEntry> persons) throws DuplicatePersonException {
        final UniqueEntryList replacement = new UniqueEntryList();
        for (final ReadOnlyEntry person : persons) {
            replacement.add(new Entry(person));
        }
