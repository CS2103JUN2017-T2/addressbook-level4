...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() throws Exception {
        ...
        EditEntryDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
    ...
    public void parse_someFieldsSpecified_success() throws Exception {
        ...
        EditEntryDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB)
    ...
    public void parse_oneFieldSpecified_success() throws Exception {
        ...
        EditEntryDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(userInput, expectedCommand);
    ...
    public void parse_invalidValueFollowedByValidValue_success() throws Exception {
        ...
        EditEntryDescriptor descriptor = new EditPersonDescriptorBuilder().withPhone(VALID_PHONE_BOB).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(userInput, expectedCommand);
    ...
    public void parse_resetTags_success() throws Exception {
        ...
        EditEntryDescriptor descriptor = new EditPersonDescriptorBuilder().withTags().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
