...
=== Searching all entries containing given keywords in the name or labels: `search`

Searches for entries which names or labels contain all of the given keywords. +
Format: `search KEYWORD_1 [KEYWORD_2 ...] [-archive|-bin]`

****
* The search is case insensitive. e.g `meeting` will match `Meeting`
* The order of the keywords does not matter. e.g. `meeting group` will match `group meeting`
* The name and label are searched.
...
* *Search* : `search KEYWORD_1 [KEYWORD_2 ...] [-archive | -bin]` +
e.g. `search lecture`
