...
Format: `add ENTRY_NAME [/on | /from | /at | /by DATE_TIME_A] [/to DATE__TIME_B] [/every day | week | month | year [NUM_TIMES | /until STOP_DATE]] [/tag TAG_1 TAG_2...]`
...
* Reminder that `DATE_TIME` must contain both date and time fields as described in Command Format above.
* /every can be used as an optional command to create recurring tasks.
* /tag can be used as an optional command to tag
****
...
Format: `edit [KEYWORD_1 KEYWORD_2...] | [/event | /deadline | /float INDEX] [/name NEW_ENTRY_NAME] [/on | /by DATE_A] [/to DATE_B] [/every day | week | month | year [NUM_TIMES | /until STOP_DATE] [/tag TAG_1 TAG_2...]`
...
e,g, `complete group meeting` or `complete /event | /deadline | /float 3`
* *List* : `list [/from START_DATE] [/to END_DATE] [/archive | /bin]` +
e.g. `ENTRY_OUTPUT_FORMAT_TO_BE_CONFIRMED`
* *Edit* : `edit [KEYWORD_1 KEYWORD_2...] | [/event | /deadline | /float INDEX] [/name NEW_ENTRY_NAME] [/on | /by DATE_A] [/to DATE_B] [/every day | week | month | year [NUM_TIMES | /until STOP_DATE] [/tag TAG_1 TAG_2...]` +
