...
** The keyword searches both the entry name and tags.
** The index refers to the index number shown in the last entry listing. The index *must be a positive integer* 1, 2, 3, ...
