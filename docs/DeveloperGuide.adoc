...
* exposes several `UnmodifiableObservableList<ReadOnlyEntry>` that can be 'observed' e.g. the UI can be bound to this list so that the UI automatically updates when the data in the lists change.
