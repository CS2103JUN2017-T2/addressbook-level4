...
=======
By: `Team 2`      Since: `Jun 2016`      Licence: `MIT`
>>>>>>> V0.0
...
2. ProductNameHere creates the entry and moves it to active list.
3. Use case ends.
...
i) ProductNameHere shows an error message and prints the proper usage_message for adding new entries.
...
3. ProductNameHere makes the modification and moves the entry to archive.
4.  Use case ends.
...
2. ProductNameHere searches for the entry.
3. ProductNameHere makes the modification and moves the entry to deleted bin.
4. Use case ends.
...
4. ProductNameHere searches for the relevant entry.
5. ProductNameHere makes the modification.
6. Use case ends.
...
3. User undo changes.
4. ProductNameHere removes all changes made by the last command.
...
2. ProductNameHere searches for the relevant entry.
3. ProductNameHere restores the entry.
4. Use case ends.
