...
|`* * *` |user |view the next `n` number of entries |see upcoming events to attend/tasks to finish
...
|`* *` |user |tick off sub-entries within an entry as completed |track my progress
...
2. ProductNameHere shows the list of entries sorted by end date/time, starting from the soonest. +
Use case ends.
