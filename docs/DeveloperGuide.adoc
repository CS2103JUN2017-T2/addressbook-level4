...
3. After some time, user decides to reschedule the entry by providing a keyword in the entry's name and a field to change.
...
4a. ProductNameHere finds more than one entries with the same keyword in the names.
