...
. The app should be able to hold up to 1000 entries without a noticeable sluggishness in performence for typical usage.
.  A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.
.  The software should use text files for storage and not relational databases.
.  The software should favor DOS stile commands over Unix-style commands.
